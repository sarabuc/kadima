...
exports.getOneMipuysForPatient = functions.https.onCall((data, context) => __awaiter(this, void 0, void 0, function* () {
    try {
        const Pid = data.text;
...
*/
//# sourceMappingURL=getMipuyForSecondAreas.js.map