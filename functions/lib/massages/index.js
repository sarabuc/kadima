...
const onceAWeek = require("./once-a-week");
const onceADay = require("./once-a-day");
exports.do_once_a_day = onceADay.do_once_a_day;
exports.do_once_a_week = onceAWeek.do_once_a_week;
